...
import { KeycloakConfig, KeycloakEvent, KeycloakEventType, KeycloakInitOptions, KeycloakService } from 'keycloak-angular';
...
export class OKeycloakMultitenantAuthService extends MultitenantAuthService {
  ...
  constructor(protected injector: Injector) {
    ...
    this.locationStrategy = injector.get<LocationStrategy>(LocationStrategy as Type<LocationStrategy>);
